export default function Footer() {
  return (
    <footer className="py-8 border-t border-border flex flex-row flex-wrap items-center justify-between gap-3">
      ...
      <nav className="flex items-center gap-8">
        ...
        <a href="https://drive.google.com/file/d/1giqkhbf_SkkUrd7sGWvJnmjIPBNxeBph/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="text-sm text-muted underline decoration-divider underline-offset-2 hover:text-foreground hover:decoration-foreground transition-colors">CV</a>
